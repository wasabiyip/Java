...
public class greedy_no {
	...
	// out
	static String out = "/greedy_no/assign.txt";

// evaluation
	
	 // real ex
	  static String running_time_read = "/greedy_no/running_time.txt";
static String distribution_assginment = "/greedy_no/distribution_assginment.txt";
static String distribution_coi = "/greedy_no/distribution_coi.txt";
static String average_coi = "/greedy_no/average_coi.txt";
static String average_topic = "/greedy_no/average_topic.txt";
static String average_topiccoverd = "/greedy_no/average_topiccoverd.txt";
static String distribution_coverdtopic = "/greedy_no/distribution_coverdtopic.txt";
/*
	 
static String running_time_read = "test/greedy_no/running_time.txt";
static String distribution_assginment = "test/greedy_no/distribution_assginment.txt";
static String distribution_coi = "test/greedy_no/distribution_coi.txt";
static String average_coi = "test/greedy_no/average_coi.txt";
static String average_topic = "test/greedy_no/average_topic.txt";
static String average_topiccoverd = "test/greedy_no/average_topiccoverd.txt";
static String distribution_coverdtopic = "test/greedy_no/distribution_coverdtopic.txt";
*/
	public static void main(String[] arg) {
		...
		// real ex
		  ...
		  paper_ID=arg[0]+paper_ID; reviewer_ID=arg[0]+reviewer_ID; out
		 =arg[0]+out;
