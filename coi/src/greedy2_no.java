...
public class greedy2_no {
	...
	// out
	static String out = "/greedy2_no/assign.txt";

// evaluation
	

static String running_time_read = "/greedy2_no/running_time.txt";
static String distribution_assginment = "/greedy2_no/distribution_assginment.txt";
static String distribution_coi = "/greedy2_no/distribution_coi.txt";
static String average_coi = "/greedy2_no/average_coi.txt";
static String average_topic = "/greedy2_no/average_topic.txt";
static String average_topiccoverd = "/greedy2_no/average_topiccoverd.txt";
static String distribution_coverdtopic = "/greedy2_no/distribution_coverdtopic.txt";

	/* 
static String running_time_read = "test/greedy2_no/running_time.txt";
static String distribution_assginment = "test/greedy2_no/distribution_assginment.txt";
static String distribution_coi = "test/greedy2_no/distribution_coi.txt";
static String average_coi = "test/greedy2_no/average_coi.txt";
static String average_topic = "test/greedy2_no/average_topic.txt";
static String average_topiccoverd = "test/greedy2_no/average_topiccoverd.txt";
static String distribution_coverdtopic = "test/greedy2_no/distribution_coverdtopic.txt";
*/
	...
	public static void main(String[] arg) {
		...
		//real ex
		 if (arg.length<=0){
		  System.out.println("Please input the parameter again!"); } else{
		 setting=arg[0]+setting; reviewer_paper=arg[0]+reviewer_paper;
		 paper_topic=arg[0]+paper_topic; reviewer_topic=arg[0]+reviewer_topic;
		  paper_ID=arg[0]+paper_ID; reviewer_ID=arg[0]+reviewer_ID; 
		  out=arg[0]+out;

		  running_time_read=arg[0]+running_time_read;
		  distribution_assginment=arg[0]+distribution_assginment;
		  distribution_coi=arg[0]+distribution_coi;
		  average_coi=arg[0]+average_coi;
		  average_topic=arg[0]+average_topic;
		  average_topiccoverd=arg[0]+average_topiccoverd;
		  distribution_coverdtopic=arg[0]+distribution_coverdtopic;
...
//topic per paper//ca
	...
	//average topic per paper
		...
		//	System.out.println(casort);
			Double to=(double)casort/paper_number;
