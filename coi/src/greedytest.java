...
public class greedytest {
	...
	// out
	static String out = "/greedy/assign.txt";

// evaluation
	/*
	 * real ex
	 * static String running_time_read = "/greedy/running_time.txt";
static String distribution_assginment = "/greedy/distribution_assginment.txt";
static String distribution_coi = "/greedy/distribution_coi.txt";
static String average_coi = "/greedy/average_coi.txt";
static String average_topic = "/greedy/average_topic.txt";
static String average_topiccoverd = "/greedy/average_topiccoverd.txt";
static String distribution_coverdtopic = "/greedy/distribution_coverdtopic.txt";
	 * 
	 * 
	 * ***
	 */
static String running_time_read = "test/greedy/running_time.txt";
static String distribution_assginment = "test/distribution_assginment.txt";
static String distribution_coi = "test/distribution_coi.txt";
static String average_coi = "test/average_coi.txt";
static String average_topic = "test/average_topic.txt";
static String average_topiccoverd = "test/average_topiccoverd.txt";
static String distribution_coverdtopic = "test/distribution_coverdtopic.txt";
	...
	public static void main(String[] arg) {
		 ...
		 * =arg[0]+out;
		 * 
		 * running_time_read+=arg[0];
		 * distribution_assginment+=arg[0];
		 * distribution_coi+=arg[0];
		 * average_coi+=arg[0];
		 * average_topic+=arg[0];
		 * average_topiccoverd+=arg[0];
		 * distribution_coverdtopic+=arg[0];
		 * 
		 */
...
long startTime1 = System.currentTimeMillis();
			for (int i = 0; i < paper_number; i++) {
				...
				for (int l = 0; l < paper_q; l++) {
					...
					int index = aList.get(position).indexOf(tempmax);
...
//topic per paper//ca
	...
	//percentage-paper
			...
			for(int m=0;m<paper_number;m++){
				...
				System.out.println(ca_sort.get(m));//(ca_sort.get(m)-newca.get(m)));//+" "+ca_sort.get(m));
