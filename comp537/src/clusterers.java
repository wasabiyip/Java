...
public class clusterers extends ArrayList {
  ...
  */
   ...
   */
  public clusterers (Object o, double wt) {
    this();
    add (o, wt);
  }
   ...
   */ 
  public void copyElements(clusterers old_cluster) throws Exception {
